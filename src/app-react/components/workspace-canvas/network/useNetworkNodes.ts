...
import { NETWORK_CONNECTION_FILE_PREFIX, NETWORK_INPUT_NODE, NetworkPaletteItemSize } from "src/consts/consts";
import {
...
import { CreateNodeParams, NetworkNodeDataUI } from "src/redux/types/ui/networkNodes";
