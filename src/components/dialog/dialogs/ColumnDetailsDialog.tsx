import { ColumnDetailsDialogParams } from "src/redux/types/ui/dialogs";
import BaseDialog from "../support/BaseDialog";
import { ColumnDetailsDialogContent } from "src/components/column-details-dialog/ColumnDetailsDialogContent";
