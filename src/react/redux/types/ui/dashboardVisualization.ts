...
import { Table } from "src/react/components/dashboard-visualization/components/Table/Table";
import { TextArea } from "src/react/components/dashboard-visualization/components/TextArea/TextArea";
import { TimeSeries2 } from "src/react/components/dashboard-visualization/components/TimeSeries2/TimeSeries";
import {
...
import { Histogram } from "src/react/components/dashboard-visualization/components/Histogram/Histogram";
import { Histogram3D } from "src/react/components/dashboard-visualization/components/Histogram3D/Histogram3D";
