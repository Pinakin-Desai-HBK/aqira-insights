...
import { useGetPropertiesDataQuery } from "src/react/redux/api/appApi";
import { PropertyGroupData } from "src/react/redux/types/schemas/properties";
import { skipToken } from "@reduxjs/toolkit/query";
import { parse as jsonBigIntParse } from "json-bigint";
import { PropertyGroupsData } from "src/react/redux/types/ui/properties";
import { WorkspaceTypes } from "src/react/redux/types/redux/workspaces";
import { selectStore_UI_Workspace_SelectedWorkspaceItem } from "src/react/redux/slices/ui/workspace/workspaceSlice";
