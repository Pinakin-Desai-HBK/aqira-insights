...
import { PaletteItemProps } from "src/react/redux/types/ui/palette";
import { appLabels } from "src/react/consts/labels";
import { useGetPropertiesDataForTypeQuery } from "src/react/redux/api/appApi";
import { useAppDispatch } from "src/react/redux/hooks/hooks";
import { uiWorkspace_setCurrentlyDraggingProperties } from "src/react/redux/slices/ui/workspace/workspaceSlice";
