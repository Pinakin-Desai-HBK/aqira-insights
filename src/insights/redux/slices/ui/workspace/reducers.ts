...
import { UIWorkspaceSlice, WorkspaceId, WorkspaceTypes } from "src/insights/redux/types/redux/workspaces";
...
import { PaletteData } from "src/insights/redux/types/ui/palette";
