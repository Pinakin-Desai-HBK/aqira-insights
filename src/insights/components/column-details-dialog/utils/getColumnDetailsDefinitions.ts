...
import { DetailsDataColumns } from "src/insights/redux/types/schemas/dataExplorer";
import { appLabels } from "src/insights/consts/labels";
import { prepareColumnDefinitions } from "./prepareColumnDefinitions";
import { COLUMN_DEFINITIONS_DEFAULT_COLUMN_WIDTH } from "src/insights/consts/consts";
