...
import { DisableTooltipZoomPanModifier } from "src/insights/components/dashboard-visualization/components/Shared/chart/prepare/customModifiers/DisableTooltipZoomPanModifier";
