import { Bin, ScaleType } from "src/insights/components/dashboard-visualization/components/Histogram/types";
import { getClosestToZero } from "./getClosestToZero";
import { TSciChart, XyCustomFilter, XyDataSeries } from "scichart";
import { filter } from "src/insights/components/dashboard-visualization/components/Shared/chart/prepare/utils/logFilter";
