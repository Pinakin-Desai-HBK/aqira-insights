import { DialogContextData, InformationDialogParams } from "src/insights/redux/types/ui/dialogs";
...
import { isZoomed } from "src/insights/components/dashboard-visualization/components/TimeSeries2/context/hooks/utils/isZoomed";
