import { ColumnDetailsDialogParams } from "src/insights/redux/types/ui/dialogs";
import BaseDialog from "../support/BaseDialog";
import { ColumnDetailsDialogContent } from "src/insights/components/column-details-dialog/ColumnDetailsDialogContent";
