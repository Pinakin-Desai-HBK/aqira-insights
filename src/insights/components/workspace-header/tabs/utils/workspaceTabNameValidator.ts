import { NameInputValidationError } from "src/insights/redux/types/ui/dialogs";
import { getLabelPart } from "./getLabelPart";
import { WorkspaceTabNameValidatorParams } from "src/insights/redux/types/ui/workspaceTabs";
