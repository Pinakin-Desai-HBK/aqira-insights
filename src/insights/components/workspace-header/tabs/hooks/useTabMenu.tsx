...
import { getLabelPart } from "src/insights/components/workspace-header/tabs/utils/getLabelPart";
import { useAppDispatch } from "src/insights/redux/hooks/hooks";
import { useUpdateWorkspaceNameMutation, useDeleteWorkspaceMutation } from "src/insights/redux/api/appApi";
import { UseTabMenuParams } from "src/insights/redux/types/ui/workspaceTabs";
import KeyboardArrowDownIcon from "@mui/icons-material/KeyboardArrowDown";
import { uiProject_openPopout } from "src/insights/redux/slices/ui/project/projectSlice";
...
import { useProjectIO } from "src/insights/components/header/hooks/useProjectIO";
import { ActionTypes, MenuActionHandler } from "src/insights/redux/types/actions";
import { workspaceTabNameValidator } from "../utils/workspaceTabNameValidator";
import { DeleteTabMessage } from "src/insights/redux/types/ui/messages";
import CloseIcon from "@mui/icons-material/Close";
import EditIcon from "@mui/icons-material/Edit";
import { PythonIcon } from "src/insights/components/icon/Icon";
import ArrowOutward from "@mui/icons-material/ArrowOutward";
import { popoutDetails } from "src/insights/popoutDetails";
import { MenuItem } from "src/insights/redux/types/ui/menu";
import { MenuButton } from "src/insights/components/menu/MenuButton";
