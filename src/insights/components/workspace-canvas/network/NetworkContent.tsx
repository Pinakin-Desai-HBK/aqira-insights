...
import { NetworkPaletteItemSize, networkReactFlowEdgeTypes, networkReactFlowTypes } from "src/insights/consts/consts";
import { CurrentlyDraggingNodeDetails, TypedWorkspace } from "src/insights/redux/types/redux/workspaces";
import { useRepositionView } from "../shared/useRepositionView";
import { insertNodeOnConnection } from "./edge/insertNodeOnConnection";
import { useCreateNetworkConnectionMutation, useDeleteNetworkConnectionMutation } from "src/insights/redux/api/appApi";
import useAutoLayout from "./autolayout/useAutoLayout";
import { PropertiesData } from "src/insights/redux/types/schemas/properties";
import {
