...
import { NETWORK_CONNECTION_FILE_PREFIX, NETWORK_INPUT_NODE, NetworkPaletteItemSize } from "src/insights/consts/consts";
import {
...
import { CreateNodeParams, NetworkNodeDataUI } from "src/insights/redux/types/ui/networkNodes";
