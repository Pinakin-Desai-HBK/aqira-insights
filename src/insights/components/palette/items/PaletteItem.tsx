...
import { PaletteItemProps } from "src/insights/redux/types/ui/palette";
import { appLabels } from "src/insights/consts/labels";
import { useGetPropertiesDataForTypeQuery } from "src/insights/redux/api/appApi";
import { useAppDispatch } from "src/insights/redux/hooks/hooks";
import { uiWorkspace_setCurrentlyDraggingProperties } from "src/insights/redux/slices/ui/workspace/workspaceSlice";
